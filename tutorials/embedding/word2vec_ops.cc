...
REGISTER_OP("SkipgramWord2vec")
    ...
    .Output("labels: int32")
    .Output("example_positions: uint64")
    .Output("label_positions: uint64")
    .SetIsStateful()
    ...
    .Attr("gradient_ranking: bool = false")
    .Doc(R"doc(
...
REGISTER_OP("NegTrainWord2vec")
    ...
    .Input("labels: int32")
    .Input("example_positions: uint64")
    .Input("label_positions: uint64")
    .Input("lr: float")
    .Input("pos_by_gradient_ladder: Ref(int32)")
    .Input("gradient_ladder: Ref(float)")
    .Output("o_examples: int32")
    .Output("o_example_positions: uint64")
    .Output("o_gradients: float")
    .SetIsStateful()
